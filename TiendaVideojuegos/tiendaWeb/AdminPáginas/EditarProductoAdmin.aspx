...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="min-height: 100vh">
        <!-- Mostramos los datos del videojuego a editar (placeholders) con sus correspondientes TextBox para rellenar los campos -->
         <div class="container-fluid align-content-center" style="width: 700px; padding-top: 20px; padding-right: 20px; padding-left: 20px; padding-bottom: 20px;">
            <ItemTemplate>
                <div class="form">
                    ...
                    <br />
                    <!-- Género del videojuego (dropdownlist que lista todos los géneros exitentes) -->
                    <div>
                    ...
                    <br />
                    <!-- Desarrolladora del videojuego (dropdownlist que lista todas las desarrolladoras exitentes) -->
                    <div>
