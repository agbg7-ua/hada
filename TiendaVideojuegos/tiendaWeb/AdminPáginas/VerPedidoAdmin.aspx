<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="VerPedidoAdmin.aspx.cs" Inherits="tiendaWeb.AdminPáginas.VerPedidoAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="min-height: 100vh">
        <!-- ListView para listar las Líneas de Pedido de un Pedido -->
        <asp:ListView runat="server" ID="listView" OnItemDataBound="ImagenProducto">
            ...
            <LayoutTemplate>
                ...
                <!-- Columnas: línea de pedido, imagen de producto, nombre de producto, cantidad e importe -->
        ...
        <!-- Label que aparecerá cuando no haya líneas de pedido -->
