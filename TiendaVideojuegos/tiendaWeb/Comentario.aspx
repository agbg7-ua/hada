...
<div class="game" style="width: 55%; float:left; height:295px; border: 3px solid mediumpurple">
    ...
    <div class="desc" style="width: 55%; float:right; height:288px">
        <br/>
    <h3> NBA 2K23</h3><br/>
    <p>NBA 2K23 es un videojuego de baloncesto de 2022 desarrollado por Visual Concepts y publicado por 2K, basado en la Asociación Nacional de Baloncesto. Es la entrega número 24 de la franquicia NBA 2K y es el sucesor de NBA 2K22.</p>
    </div>
</div>
<div class ="father" style="width: 45%; float:right; height:1000px;">
